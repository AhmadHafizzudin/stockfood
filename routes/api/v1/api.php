...
Route::group(['namespace' => 'Api\V1', 'middleware'=>['localization','react']], function () {
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::prefix('v1')->group(function () {
            Route::post('/payment/zenpay/session', [ZenPayController::class, 'createCheckoutSession'])->name('createCheckoutSession');
            Route::post('/payment/zenpay/webhook', [ZenPayController::class, 'webhook'])->name('webhook'); // public
        });
