...
// Simple test script for Lalamove API
...
// Test quotation data - try different market formats
$markets = ['MY', 'MALAYSIA', 'my', 'malaysia'];

foreach ($markets as $market) {
    echo "Testing with market: $market\n";
    ...
    if ($httpCode == 200) {
        echo "✅ API test successful with market: $market!\n";
        ...
        echo "❌ API test failed with market: $market\n";
